/**
 * SecuritySettingsPreview - Preview version of Security Settings page
...
import { Shield, KeyRound, Fingerprint, MonitorSmartphone, AlertOctagon, ArrowRight, Settings2, Bell, Mail, AlertTriangle } from "lucide-react";
import { Link } from "react-router-dom";
import { PreviewWrapper } from '@/components/debug/PreviewWrapper';
import { useState } from "react";

// Mock notification preferences
function MockSecurityNotificationPreferences() {
  const [preferences, setPreferences] = useState({
    security_alerts: true,
    login_notifications: true,
    suspicious_activity: true,
    weekly_security_report: false,
  });
      ...
      <CardContent className="space-y-6">
        ...
        <div className="flex items-center gap-3 p-3 rounded-lg bg-amber-500/10 border border-amber-500/20">
          ...
          <div className="flex-1">
            <p className="text-sm font-medium text-amber-600 dark:text-amber-400">
              Email notifications globally disabled
            </p>
            <p className="text-xs text-muted-foreground">
              Enable email notifications in general settings to receive security alerts
            </p>
          </div>
        </div>
        ...
        <div className="space-y-4">
          {[
            ...
            {
              key: 'weekly_security_report' as const,
              label: 'Weekly Security Report',
              description: 'Receive a weekly summary of your account security',
              icon: Mail,
            },
          ].map((item) => (
            <div 
...
export default function SecuritySettingsPreview() {
  ...
  return (
    <PreviewWrapper pageName="Security Settings">
      <div className="min-h-screen bg-background">
        ...
        <div className="max-w-5xl mx-auto px-4 py-8 space-y-8">
          ...
          >
            <MockSecurityNotificationPreferences />
          </motion.div>
