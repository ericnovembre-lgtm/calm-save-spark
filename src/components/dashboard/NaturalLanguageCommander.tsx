        ...
        {!isExpanded && (
          <motion.button
            ...
            className={cn(
              ...
              "shadow-[0_4px_24px_-4px_hsla(0,0%,0%,0.1),0_0_0_1px_hsla(var(--foreground),0.02)]",
              "hover:shadow-[0_8px_32px_-4px_hsla(0,0%,0%,0.14),0_0_0_1px_hsla(var(--primary),0.12)]",
          ...
          >
            ...
            {!prefersReducedMotion && (
              <motion.div
                ...
                style={{ 
                  background: 'linear-gradient(135deg, hsla(var(--primary), 0.15), hsla(var(--accent), 0.2), hsla(var(--primary), 0.15))',
            ...
            <motion.div
              ...
              animate={!prefersReducedMotion ? { scale: [1, 1.06, 1] } : undefined}
              transition={{ duration: 2.5, repeat: Infinity, ease: 'easeInOut' }}
            >
              <Search className="w-4 h-4 text-foreground/60 group-hover:text-primary transition-colors duration-300" />
            </motion.div>
            <span className="hidden sm:inline relative z-10">Ask anything about your finances...</span>
            <span className="sm:hidden relative z-10">{isVoiceSupported && isMobile ? 'Tap to speak...' : 'Ask AI...'}</span>
            <motion.div 
              className="relative z-10"
              animate={!prefersReducedMotion ? { rotate: [0, 8, -8, 0] } : undefined}
              transition={{ duration: 5, repeat: Infinity, ease: 'easeInOut' }}
            >
              {isVoiceSupported && isMobile ? (
                <Mic className="w-3.5 h-3.5 text-primary/60 group-hover:text-primary transition-colors duration-300" />
              ) : (
