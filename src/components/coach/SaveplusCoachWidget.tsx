...
export function SaveplusCoachWidget() {
  ...
  if (isMinimized) {
    return (
      <button
        ...
        className="fixed bottom-6 left-6 z-40 flex items-center gap-2 px-3 py-2 bg-primary/80 text-primary-foreground rounded-full shadow-md hover:shadow-lg transition-all hover:scale-105 backdrop-blur-sm opacity-85 hover:opacity-100"
  ...
  return (
    <motion.div
      ...
      className="fixed bottom-6 left-6 z-40 w-full max-w-[200px]"
    >
      <Card className="shadow-sm border border-primary/10 bg-background/85 backdrop-blur-md">
